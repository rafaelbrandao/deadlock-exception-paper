...
% Add reference to the source that says I can use interaction(replica, lock) %
...
% TODO: add the link to the script and the data used (anonymized) %
...
% TODO: move attachments to the end of paper instead of this section, or move some of them out of the paper (put as links) %
