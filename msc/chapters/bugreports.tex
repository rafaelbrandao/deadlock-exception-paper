\chapter{Bug Reports Study}\label{bugs}
...
Initially a search for bug reports was conducted in each repository for the keyword \emph{deadlock}, collecting 541 bug reports in total.
